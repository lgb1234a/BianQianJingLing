...
@property (weak, nonatomic) id<CCMPlayNDropViewDelegate> delegate;
...
@property (strong, nonatomic)WeatherTipView *weatherView;   // 天气
@property (strong, nonatomic)NoteTipView *noteView;   // 笔记
@property (strong, nonatomic)AccountTipView *accountView; // 账本
@property (strong, nonatomic)RestdayTipView *restDayTipView; // 倒数日
@property (strong, nonatomic)NotificationTipView *notificationView; // 提醒
